                                 ...
                                 listbinhluan.length > 0 ?
                                    listbinhluan.map(data => (
                                       <TableRow key={data.id}>
                                          ...
                                          {
                                             data.trangThai == true ?
                                                <TableCell className={classes.UnBlock} align="center">Đã xem</TableCell> :
                                                <TableCell className={classes.ColorICond} align="center">Chưa xem</TableCell>
                                          }
                                 ...
                                 listblock.length > 0 ?
                                    listblock.map(data => (
                                       <TableRow key={data.id}>
                                          ...
                                          <TableCell align="center">{data.email}</TableCell>
                                          {
                                             data.spam == true ? <TableCell align="center" className={classes.ColorICond}>Đã chặn</TableCell> :
                                                <TableCell className={classes.UnBlock} align="center">Chưa chặn</TableCell>
                                          }
                                          <TableCell align="center">
                                             <Controls.ActionButton
                                                color="primary"
