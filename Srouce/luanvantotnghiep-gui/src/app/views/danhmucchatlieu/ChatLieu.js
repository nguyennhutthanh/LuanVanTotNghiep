        ...
        <>
            <div className="m-sm-30">
                <div className="mb-sm-30">
                    <Breadcrumb
                        routeSegments={[
                            { name: 'Nguyên liệu', path: '/danhmucchatlieu' },
                        ]} />
                </div>
                <SimpleCard title="Danh mục nguyên liệu" >
                    <Toolbar>
                        <Grid item xs={7}
                    ...
                    <TblContainer>
                        <TableHead>
                            <TableRow>
                                <TableCell className="bg-light-green" align="center">Mã nguyên liệu</TableCell>
                                <TableCell className="bg-light-green" align="center">Tên nguyên liệu</TableCell>
