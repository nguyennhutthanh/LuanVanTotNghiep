...
const useStyles = makeStyles(({ palette, ...theme }) => ({
	cardHolder: {
		background: 'linear-gradient(45deg, red, #00000040, #61e111b3, #ff6a00f0)',
	},
	card: {
		maxWidth: 800,
		borderRadius: 12,
	...
	Map2: {
		fontSize: '2.2rem',
		textAlign: 'center',
		background: '-webkit-linear-gradient(right,rgb(32 31 31 / 74%), rgb(17 201 5))',
			...
			<Card className={classes.card}>
				<Grid container className={classes.Map1}>
					<Grid item lg={5} md={5} sm={5} xs={12}>
						<div className="p-8 flex justify-center items-center h-300">
							<img
								className="w-300"
								src="/img/logo.png"
								alt=""
					...
					<Grid item lg={7} md={7} sm={7} xs={12} className={classes.Map3}>
						<h4 className={classes.Map2}>FarmNha</h4>
