...
const TabSlider = () => {
	...
	const renderList = rooms.map((rooms) => {
		...
		return (
			<li className="item parent group" key={id}>
				<Link to={`/Products/${id}`} className="hasicon" title={tenLoai.toUpperCase()}>
					<img src={urlAnhDaiDien} alt="img" />{tenLoai.toUpperCase()}
				</Link>
							...
							<div className="menu-content">
								<div className="tags">
									<div className="title float-left">
										<b>{interfaceRoomNavigation.tenRoom.toUpperCase()}</b>
									</div>
	...
	return (
		<div className="container">
			<div className="section menu-banner d-xs-none"
				style={{ margin: '-4% 0px 0px 7%' }}>
				<div className="tiva-verticalmenu block">
					<div className="box-content">
						<div className="verticalmenu" role="navigation">
							<ul className="menu level1" style={{ width: '145%' }}>
