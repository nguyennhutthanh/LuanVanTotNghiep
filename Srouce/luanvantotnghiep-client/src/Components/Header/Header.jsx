	...
	return (
		<div id="home4">
			<header>
				...
				{/* header desktop */}
				<div className="header-top d-xs-none" style={{ position: 'fixed' }}>
					<div className="container">
						<div className="row margin-0">
							...
							{/* logo */}
							<div className="flex-2 d-flex  align-items-center justify-content-center" style={{ marginLeft: '40px' }}>
								<div id="logo">
									<Link to="/">
							...
							<div className="main-menu d-flex align-items-center justify-content-start navbar-expand-md" style={{ marginRight: '4%', marginLeft: '1%' }}>
